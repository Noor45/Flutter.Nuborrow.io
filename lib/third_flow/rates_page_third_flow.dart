...
import 'package:nuborrow/third_flow/complete_application_third_flow.dart';
import 'package:page_transition/page_transition.dart';
import '../cards/rate_page_card.dart';

class RatesPage3rdFlow extends StatefulWidget {
  static const RatesPage3rdFlowId = 'rates3';
  @override
  _RatesPage3rdFlowState createState() => _RatesPage3rdFlowState();
}

class _RatesPage3rdFlowState extends State<RatesPage3rdFlow> {
...
class _ViewContentState extends State<ViewContent> {
  ...
  navigate(){
    Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, duration: Duration(seconds: 1), child: LastPage3rdFlow()));
  }
}
